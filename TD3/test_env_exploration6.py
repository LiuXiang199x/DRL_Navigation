...
class GazeboEnv:
    ...
    def reset(self, sl_Process=None):
        ...
        if self.repeat_num == -1:
            self.repeat_num = 5
            self.episode_num = self.episode_num % 140 + 1 #4 #+= 1
        ...
        print("==========Reseting: initial position, number of map", state, self.episode_num)
