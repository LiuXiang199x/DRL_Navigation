...
class GlobalPolicy(nn.Module):
    ...
    def act(self, inputs, rnn_hxs, prev_actions, masks, deterministic=False):
        ...
        action_mask = inputs["frontier_mask"] * (1 - free_mask)
...
if __name__ == '__main__':
    ...
    # save checkpoint
    CHECKPOINT_FOLDER = os.path.join(os.path.dirname(__file__), "new_checkpoints43")
    ...
    env = GazeboEnv('test_move_base9.launch', 1, 1, 1)
    time.sleep(4)
    port = '11311'
